...
(function() {
  var cc, compiler, computecluster, get_dist_filename, md5, save_versions_mapping, syspath, uglifycss, ujs, utils;
  ...
  exports.run = function(options) {
    var conf, done, i, list, script_global, toRun, vertype, _i, _len, _results;
    ...
    conf.each_export_files(function(srcpath, parents, opts) {
      ...
      return script_global.EXPORT_MAP[get_dist_filename(opts.partial_path)] = iter;
    });
