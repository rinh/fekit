...
(function() {
  var compiler, md5, minCode, process_directory, process_single_file, save_versions_mapping, syspath, uglifycss, ujs, utils;
  ...
  process_directory = function(options) {
    var conf, script_global, vertype, _get_dist_filename;
    ...
    _get_dist_filename = function(srcpath) {
      var ext, t, _extname;
    ...
    conf.each_export_files(function(srcpath, parents, opts) {
      ...
      return script_global.EXPORT_MAP[_get_dist_filename(opts.partial_path)] = iter;
    });
    ...
    return conf.each_export_files_async(function(srcpath, parents, opts, seriesCallback) {
      ...
      _done = function(err, source) {
        var dest, final_code, md5code, n, _ref, _ref1;
        if (err) {
