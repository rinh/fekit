...
(function() {
  var compiler, jsp, md5, minCode, prerelease, pro, process_directory, process_single_file, save_versions_mapping, syspath, uglifycss, utils;
  ...
  process_directory = function(options) {
    ...
    return conf.each_export_files_async(function(srcpath, parents, opts, seriesCallback) {
      ...
      return prerelease.exec('prd', options, function() {
