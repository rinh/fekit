...
(function() {
  var PARAM_CACHE, charset, compiler, connect, dns, http, listenPort, md5, mime_config, qs, rewrite, setupServer, sysfs, syspath, sysurl, toMD5, toPARAM, urlrouter, utils, _rewriteObsoleteUrl, _routeRules;
