  ...
  setupServer = function(options) {
    ...
    fekitRouter = urlrouter(function(app) {
      return app.get(utils.UrlConvert.PRODUCTION_REGEX, function(req, res, next) {
        var config, ctype, host, is_deps, p, params, srcpath, url, urlconvert, _render;
        ...
        ctype = compiler.getContentType(urlconvert.uri) === "javascript" ? ".js" : void 0;
        ctype = compiler.getContentType(urlconvert.uri) === "css" ? ".css" : void 0;
        res.writeHead(200, {
