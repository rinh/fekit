...
(function() {
  var FekitConfig, Reader, UrlConvert, Writer, async, child_process, cjson, coffee, exit, fs, fse, fstream, ignore, mkdirp, ncp, request, rimraf, sty, syspath, sysutil, tar, utilarray, utilasync, utilconfig, utilfile, utilhttp, utillogger, utilpath, utilproc, utilsys, vm, yaml, zlib, _, _closest, _closest_dir, _fileExistsWithCaseSync, _runCode, _watch;
  ...
  */
  ...
  FekitConfig = (function() {
    ...
    FekitConfig.prototype.doRefs = function() {
      var fn, k, v, _ref, _results;
      ...
      for (k in _ref) {
        ...
        fn = this["_doRefs_" + k];
        if (fn) {
          _results.push(fn.apply(this, (!sysutil.isArray(v) ? [v] : v)));
        } else {
          _results.push(utillogger.error("[refs] 构建任务失败, 找不到命令 " + k));
        }
      }
      return _results;
    };
        ...
        return utilproc.setImmediate(function() {
          ...
          reader = fstream.Reader({
            ...
            filter: function(entry) {
              ...
              if (ig.filter([this.basename]).length === 0) {
                return false;
              }
