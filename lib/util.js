...
(function() {
  var FekitConfig, Reader, UrlConvert, Writer, async, child_process, cjson, exit, fs, mkdirp, syspath, utilarray, utilasync, utilconfig, utilfile, utillogger, utilpath, utilproc, utilsys, vm, yaml, _, _closest;
  ...
  */
  ...
  FekitConfig = (function() {
      ...
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        ...
        _tmp = function(file) {
          return function(seriesCallback) {
            ...
            if (utilpath.exists(path)) {
              return cb(path, parents, seriesCallback);
            } else {
    ...
    FekitConfig.prototype.doScript = function(type, global) {
      var code, path, _ref, _ref1;
      global = global || {};
