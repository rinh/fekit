...
(function() {
  var FekitConfig, Reader, UrlConvert, Writer, async, child_process, cjson, coffee, crypto, exit, find, fs, fse, fstream, ignore, mkdirp, ncp, request, rimraf, sty, syspath, sysutil, tar, utilarray, utilasync, utilconfig, utilfile, utilhttp, utillogger, utilpath, utilproc, utilself, utilsys, vm, yaml, zlib, _, _closest, _closest_dir, _fileExistsWithCaseSync, _filters, _runCode, _watch;
