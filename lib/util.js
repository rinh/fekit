...
(function() {
  var FekitConfig, Reader, UrlConvert, Writer, async, child_process, cjson, coffee, exit, fs, fse, fstream, mkdirp, ncp, request, rimraf, sty, syspath, sysutil, tar, utilarray, utilasync, utilconfig, utilfile, utilhttp, utillogger, utilpath, utilproc, utilsys, vm, yaml, zlib, _, _closest, _closest_dir, _runCode, _watch;
