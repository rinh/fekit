...
(function() {
  ...
  */
  ...
  exports.compile = function(filepath, options, doneCallback) {
    var dep_path, depsSeriesFuncs, module, use_modules, _i, _len, _ref;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      dep_path = _ref[_i];
      depsSeriesFuncs.push(function(seriesCallback) {
        var parent_module;
    ...
    return async.series(depsSeriesFuncs, function(err) {
      if (err) {
        doneCallback(err);
        return;
      }
