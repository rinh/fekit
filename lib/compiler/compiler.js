...
(function() {
  ...
  MODULE_LINE_REGEXP = /^([^\\/]*\b)(import|require)\s*\(\s*(?:["'])(.*?)(?:["'])\s*\)\s*[;]?\s*$/;
  ...
  */
  ...
  Module = (function() {
    ...
    Module.prototype.analyze = function() {
      var line, lines, module, _i, _len, _results;
      this.sources = [];
      lines = this.compiler.readlines(this.path.getFullPath());
      _results = [];
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        line = lines[_i];
        switch (this._check(line)) {
          case MODULE_LINETYPE.NORMAL_LINE:
            _results.push(this.sources.push(line));
            break;
          case MODULE_LINETYPE.IMPORT_LINE:
            module = Module.parse(line, this);
            this.depends.push(module);
            _results.push(this.sources.push(module._getPlaceHolder(line)));
            break;
          default:
  ...
  JSModule = (function(_super) {
    ...
    JSModule.prototype._getPlaceHolder = function(line) {
      ...
      if (this.config.isCompileTypeSMD()) {
  ...
  */
  ...
  ModuleConfig = (function() {
    ...
    ModuleConfig.prototype.isCompileTypeSMD = function() {
      return this.config.root.compiler === "SMD";
    };
  ...
  */
  ...
  Compiler = (function() {
    ...
    Compiler.prototype.readlines = function(path) {
      var ext, txt;
  ...
  */
  ...
  getSource = function(module, USED_MODULES) {
    var arr, sub_module, _i, _len, _ref;
    arr = [];
    _ref = module.depends;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      sub_module = _ref[_i];
  ...
  exports.compile = function(filepath, depend_filepath_list) {
    var dep_path, module, parent_module, use_modules, _i, _len, _ref;
    use_modules = {};
    module = Module.parse(filepath);
    _ref = depend_filepath_list || [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      dep_path = _ref[_i];
