...
(function() {
  var LOOPS, MAX_LOOP_COUNT, Module, addPlugin, async, autoprefixer, booster, fs, getSource, pluginsDir, postcss, syspath, utils, _,
    _this = this;
  ...
  exports.compile = function(filepath, options, doneCallback) {
    ...
    _done = function(err) {
      ...
      return getSource(module, {
        ...
        var c, plugin, _ref, _ref1;
        c = (_ref = module.config.config) != null ? (_ref1 = _ref.root) != null ? _ref1.autoprefixer : void 0 : void 0;
        if (_.isObject(c) && module.iscss) {
          plugin = autoprefixer(c);
          return postcss([plugin]).process(result).then(function(out) {
            return doneCallback(err, out.css, module);
          });
        }
