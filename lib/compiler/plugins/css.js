...
exports.ddns = function(css_code, module) {
  var RE_DOMAIN, _dms, _map, _ori, conf, fileconfig, r, ref, ref1, ref2, ref3, ref4, root_fekit_config;
  root_fekit_config = ((ref = module.root_module) != null ? (ref1 = ref.config) != null ? (ref2 = ref1.config) != null ? ref2.root : void 0 : void 0 : void 0) || {};
  ...
  } else if (root_fekit_config != null ? (ref3 = root_fekit_config.export_global_config) != null ? ref3.domain_mapping : void 0 : void 0) {
    r = root_fekit_config != null ? (ref4 = root_fekit_config.export_global_config) != null ? ref4.domain_mapping : void 0 : void 0;
  } else {
