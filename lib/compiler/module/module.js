var CSSModule, JSModule, MODULE_COMPILE_TYPE, MODULE_CONTENT_TYPE, Module, ModuleConfig, ModulePath, _, events, parser, syspath, util, utils,
...
Module = (function() {
  ...
  Module.prototype._process = function(path, cb) {
    var env, err, error, ext, plugin, source;
...
JSModule = (function(superClass) {
  extend(JSModule, superClass);
...
CSSModule = (function(superClass) {
  extend(CSSModule, superClass);
