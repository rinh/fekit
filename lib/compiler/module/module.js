...
(function() {
  var CSSModule, JSModule, MODULE_COMPILE_TYPE, MODULE_CONTENT_TYPE, Module, ModuleConfig, ModulePath, events, linter, parser, syspath, util, utils, _,
  ...
  */
  ...
  Module = (function() {
    ...
    Module.prototype._process = function(path, cb) {
      var env, ext, fatal, messages, plugin, rname, source;
          ...
          if (ext === ".js") {
            ...
            if (messages.length > 0) {
              ...
              messages.forEach(function(i) {
                if (fatal === void 0 && i.fatal === true) {
                  fatal = true;
                }
                return console.error("" + rname + ":" + i.line + ":" + i.column + " " + i.message);
              });
              if (fatal === true) {
