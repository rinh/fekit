...
(function() {
  var CSSModule, HTMLModule, JSModule, MODULE_COMPILE_TYPE, MODULE_CONTENT_TYPE, Module, ModuleConfig, ModulePath, md5, parser, syspath, utils,
  ...
  HTMLModule = (function(_super) {
    __extends(HTMLModule, _super);

    function HTMLModule(uri) {
      HTMLModule.__super__.constructor.call(this, uri);
    }

    HTMLModule.prototype.analyzed = function() {
      return this.ast.defineType('REQUIRE', function(node) {
        return "";
      });
    };

    HTMLModule.prototype.getSourceWithoutDependencies = function() {
      return this.ast.print();
    };
